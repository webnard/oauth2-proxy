...
func NewGitLabProvider(p *ProviderData) *GitLabProvider {
	...
	return &GitLabProvider{
		OIDCProvider:    oidcProvider,
		oidcRefreshFunc: oidcProvider.RefreshSessionIfNeeded,
	}
}
...
// RefreshSessionIfNeeded refreshes the session with the OIDCProvider
// implementation but preserves the custom GitLab projects added in the
// `EnrichSession` stage.
